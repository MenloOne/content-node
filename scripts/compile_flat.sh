...
./node_modules/.bin/typechain --target web3-1.0.0 --outDir ./src/contracts ./node_modules/menlo-token/build/contracts/MenloToken.json
./node_modules/.bin/typechain --target web3-1.0.0 --outDir ./src/contracts ./src/artifacts/MenloForum.json
./node_modules/.bin/typechain --target web3-1.0.0 --outDir ./src/contracts ./src/artifacts/MenloTopics.json
